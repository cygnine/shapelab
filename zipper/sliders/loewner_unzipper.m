function[w_n, z_n, mapdata] = loewner_unzipper(tooth, z_n, w_n, mapdata)
% loewner_unzipper -- Unzips one tooth using a predictive Loewner slit evolution
%
% [w_n, z_n, mapdata] = loewner_unzipper(tooth, z_n, w_n, mapdata)

persistent unzip compute_a
if isempty(unzip)
