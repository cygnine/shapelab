function[w_n, z_n, mapdata] = slit_unzipper(tooth, z_n, w_n, mapdata)
% slit_unzipper -- Unzips one tooth using the slit algorithm
%
% [w_n, z_n, mapdata] = slit_unzipper(tooth, z_n, w_n, mapdata)
